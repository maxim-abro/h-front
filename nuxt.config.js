  ...
  sitemap: {
    ...
    routes: async () => {
      ...
      const categoryData = await axios.get(
        'https://za-halyavoi.ru/api/admin/sitemap/category'
      )
      const shopData = await axios.get(
        'https://za-halyavoi.ru/api/admin/sitemap/shop'
      )
      const holidayData = await axios.get(
        'https://za-halyavoi.ru/api/admin/sitemap/holidays'
      )
      const blogData = await axios.get(
        'https://za-halyavoi.ru/api/admin/sitemap/blog'
      )
