<template>
  <div
    v-if="$store.state.popup.openMobileMenu"
  ...
  >
        ...
        <li>
          <m-collapse animation>
            ...
            <template #content>
              <div class="">
                <a
                  v-for="category in $store.state.aside.popularCategories"
                  :key="category.uin"
          ...
          <m-collapse animation>
            ...
            <template #content>
              <div class="grid grid-cols-2">
                <a
                  v-for="shop of $store.state.aside.popular"
                  :key="shop.shop.uin"
    ...
    <div
      ...
      @click="$store.commit('popup/toggleMenu')"
    ></div>
  </div>
</template>
