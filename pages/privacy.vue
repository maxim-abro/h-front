<template>
  <div class="mb-10">
    ...
    <h2 class="font-bold text-2xl pt-7 pb-6">1. Общие положения</h2>
    ...
    <p class="mb-4">
      ...
      персональных данных, предпринимаемые Абросимов Максимом Евгеньевичем
      (далее – Оператор).
    </p>
    <p class="pl-14 mb-0.5">
    ...
    <p class="pl-14 mb-0.5">
      ...
      может получить о посетителях веб-сайта https://za-halyavoi.ru/.
    </p>

    <h2 class="font-bold text-2xl pt-7 pb-6">
    ...
    <p class="pl-14 mb-0.5">
      ...
      интернет по сетевому адресу https://za-halyavoi.ru/.
    </p>
    <p class="pl-14 mb-0.5">
    ...
    <p class="pl-14 mb-0.5">
      2.10. Пользователь – любой посетитель веб-сайта https://za-halyavoi.ru/.
    </p>
    <p class="pl-14 mb-0.5">
    ...
    <p class="pl-14 mb-0.5">
      ...
      просьбе информацию, касающуюся обработки его персональных данных;<br />
      ...
      даты получения такого запроса;<br />
      ...
      в порядке и случаях, предусмотренных Законом о персональных данных;<br />
    ...
    <p class="pl-14 mb-0.5">5.1. Фамилия, имя, отчество.</p>
    <p class="pl-14 mb-0.5">5.2. Электронный адрес.</p>
    <p class="pl-14 mb-0.5">
    ...
    <p class="pl-14 mb-0.5">
      ...
      материалам, содержащимся на веб-сайте https://za-halyavoi.ru/.
    </p>
    <p class="pl-14 mb-0.5">
      ...
      support@za-halyavoi.ru с пометкой «Отказ от уведомлений о новых продуктах
    ...
    <p class="pl-14 mb-0.5">
      ...
      являются: – перечислите нормативно-правовые акты, регулирующие отношения,
      связанные с вашей деятельностью, например, если ваша деятельность связана
      с информационными технологиями, в частности с созданием сайтов, то здесь
      можно указать Федеральный закон "Об информации, информационных технологиях
    ...
    <p class="pl-14 mb-0.5">
      ...
      специальные формы, расположенные на сайте https://za-halyavoi.ru/ или
    ...
    <p class="pl-14 mb-0.5">
      ...
      уведомление на адрес электронной почты Оператора support@za-halyavoi.ru с
    ...
    <p class="pl-14 mb-0.5">
      ...
      электронный адрес Оператора support@za-halyavoi.ru с пометкой «Отзыв
    ...
    <h2 class="font-bold text-2xl pt-7 pb-6">14. Заключительные положения</h2>
    ...
    <p class="pl-14 mb-0.5">
      ...
      Оператору с помощью электронной почты support@za-halyavoi.ru.
    </p>
    <p class="pl-14 mb-0.5">
    ...
    <p class="pl-14 mb-0.5">
      ...
      Интернет по адресу https://za-halyavoi.ru/privacy.
    </p>
  </div>
</template>
