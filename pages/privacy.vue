<template>
  <div class='mb-10'>
    ...
    <p class="mb-4">
      ...
      предпринимаемые Абросимов Максимом Евгеньевичем (далее – Оператор).
    </p>
    ...
    <p class="pl-14 mb-0.5">
      ...
      получить о посетителях веб-сайта https://za-halyavoi.ru/.
    </p>
    ...
    <p class="pl-14 mb-0.5">
      ...
      в отношении персональных данных;<br />
    ...
    <p class="pl-14 mb-0.5">
      ...
      направив Оператору письмо на адрес электронной почты support@za-halyavoi.ru с
    ...
    <p class="pl-14 mb-0.5">
      ...
      указать Федеральный закон "Об информации, информационных технологиях и о
    ...
    <p class="pl-14 mb-0.5">
      ...
      формы, расположенные на сайте https://za-halyavoi.ru/ или направленные
    ...
    <p class="pl-14 mb-0.5">
      ...
      Оператора support@za-halyavoi.ru с пометкой «Отзыв согласия на обработку
      персональных данных».
    </p>
    <p class="pl-14 mb-0.5">
