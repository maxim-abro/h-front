<template>
  <div class="">
    ...
    <form action="">
      ...
      <textarea
        class="w-full focus:outline-0 rounded p-2 box-border w-full focus:outline-0 focus:ring focus:ring-primary placeholder-zinc-800 text-zinc-900 bg-gray-200"
      ></textarea>
      ...
      meta: [
        {
          ...
          name: 'description',
          content:
            this.seo.description.slice(0, 300) +
            '...' +
